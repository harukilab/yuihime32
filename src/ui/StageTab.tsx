        ...
        recognition.onresult = (event: any) => {
          ...
          if (isMicEnabledRef.current) {
            ...
            if (isWakeWordDetected && isSleepingRef.current) {
              setIsSleeping(false);
              addLog('agent', `[SYSTEM] Kata pemicu '${wakeWordKeywordRef.current}' terdeteksi! Yuihime terbangun kembali.`);
            ...
            if (isWakeWordDetected) {
              ...
              addLog('agent', `[SYSTEM] Kata pemicu '${wakeWordKeywordRef.current}' terdeteksi! Yuihime terbangun secara otomatis dan mengaktifkan mikrofon.`);
              handleTriggerAnimation('surprise');
