    ...
    configSchema: {
      fields: {
        ...
        enableOfflineTraining: {
          type: 'boolean',
          label: 'Aktifkan Latihan Bawah Sadar Luring (Offline Background Training)',
          default: true,
          description: 'Mengizinkan batin Yuihime berlatih mengonsolidasi pola ingatan dan mematangkan strategi komunikasi di latar belakang secara acak.'
        },
